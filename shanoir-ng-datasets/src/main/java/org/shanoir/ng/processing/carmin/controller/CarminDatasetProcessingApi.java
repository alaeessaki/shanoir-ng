...
public interface CarminDatasetProcessingApi {
    ...
    @ApiOperation(value = "", notes = "If exists, returns the dataset processing corresponding to the given id with carmin new fields", response = CarminDatasetProcessingDTO.class, tags = {})
    @ApiResponses(value = {
    ...
    ResponseEntity<CarminDatasetProcessingDTO> findCarminDatasetProcessingByComment(
